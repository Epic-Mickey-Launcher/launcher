...
export function GetBackgroundLogin(): BackgroundInfo {
  ...
  return {
    path: "img/backgrounds/" + background_login[random],
    credits: background_creds_login[random],
  };
}
...
export function GetBackgroundModMarket() {
  ...
  let res: BackgroundInfo = {
    path: "img/backgrounds/" + background_modmarket[random],
    credits: background_creds_modmarket[random],
  };
  return res;
}
