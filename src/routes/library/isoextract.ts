...
export async function ExtractISO(source: string, onVerified: any): Promise<string> {
    ...
    console.log("Image Validated as: " + identifiedGame.game + ", " + identifiedGame.platform + ", " + identifiedGame.region)
