...
<main>
    <body>
        <div bind:this={options}>
            <h1>
                Welcome to the Epic Mickey Launcher <img
                    style="display:inline-block;width:60px;position:relative;top:10px;rotate:calc(10deg)"
                    src="img/icon.png"
                    alt=""
                />
            </h1>
            ...
            <button on:click={() => Exit("#/Games")} class="b1"
                >Do everything manually</button
            >
        </div>

        <div style="display:none;" bind:this={quickstart}>
            <div
                style="background-color:black;width:max-content;padding:30px;margin:auto;"
            >
                <h2>How to download & use Dolphin</h2>
                <plaintext
                    >Go to the Dolphin website & Download the latest beta
                    version (https://nb.dolphin-emu.org/download/?ref=btn)</plaintext
                >
                <p>
                    <plaintext
                        >Unzip the dolphin install & open Dolphin.exe</plaintext
                    >
                </p>
                <p />
                <h3>How to dump Epic Mickey 1 & 2 for Wii using Dolphin</h3>
                <plaintext
                    >Get an ISO of EM1 or EM2 if you haven't already</plaintext
                >
                <plaintext
                    >Add the folder where your EM 1 or 2 ISO is located to
                    dolphin</plaintext
                >
                <plaintext>Right click on your ISO in dolphin</plaintext>
                <plaintext>Go to properties then Filesystem</plaintext>
                <plaintext
                    >Right click on Disc and then select Extract entire disc</plaintext
                >
                <plaintext
                    >Select a folder you want to dump the game to and press
                    Select</plaintext
                >
            ...
            <p />
            <div
                style="background-color:black;width:700px;padding:30px;margin:auto;"
            >
                <h2>How to add EM 1 & 2 to EML</h2>
                <plaintext>Go to the Games tab</plaintext>
                <plaintext>Press the Add Game Build button</plaintext>
                <plaintext
                    >Choose the folder where you've dumped your game (Folder
                    outside of the DATA folder)</plaintext
                >
                <plaintext
                    >EML will automatically find the version of the game you've
                    selected</plaintext
                >
            ...
            <p>
                <button on:click={SetDolphinPath}
                    >Assign Dolphin Path (optional)</button
                >
                <plaintext style="display:inline"
                    ><em>{currentDolphinPath}</em></plaintext
                >
            </p>
            <p>
                <button on:click={() => Exit("Games")} class="b1"
            ...
            <p>
                <button on:click={() => Exit("addgame")} class="b1"
                    >Add Game Build</button
                >
            </p>
        </div>
    </body>
