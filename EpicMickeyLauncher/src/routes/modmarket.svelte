...
<select class="dropdown" bind:value={selectedgamebuild} on:change="{() => LoadModList()}" bind:this={GamesDropdown}>
   {#await SetJsonData()}
...
<p style="position:relative;top:400px;">You don't have any game builds set up yet!</p>
</div>
